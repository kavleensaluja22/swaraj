...
# ALLOWED_HOSTS = ["159.223.83.68","www.swarajtractorharyana.com","swarajtractorharyana.com"]
ALLOWED_HOSTS = ['*']
...
# AUTHENTICATION_BACKENDS = [    'django.contrib.auth.backends.ModelBackend',    'django_otp.plugins.otp_static.StaticDeviceOTPBackend',    'django_otp.plugins.otp_totp.TOTPDeviceBackend',    'django_otp_callback.backends.CallbackDeviceBackend',]
